...
public class Edit_TimeFrame_Controller implements Initializable {
	...
	private void finishEditing() {
		...
		if (datePicker.getValue() == null || driverChoiceBox.getSelectionModel().getSelectedItem().equals("")
			...
			Edit_TimeFrame_Event_Object obj = new Edit_TimeFrame_Event_Object(storeID, orderID,
					customerNameTxt.getText(), Date.valueOf(datePicker.getValue()), townTxt.getText(),
					driverChoiceBox.getSelectionModel().getSelectedItem(), orderNumberTxt.getText(),
					timeframeTxt.getText());
	...
	public void setTextFieldInformaition(TimeFrame_Model timeFrame_Model, Store_Model store_Model) {
		...
		orderID = timeFrame_Model.getOrderID();

		storeNameTxt.setText(store_Model.getStoreName());
		customerNameTxt.setText(timeFrame_Model.getCustomerName());
		townTxt.setText(timeFrame_Model.getTown());
		timeframeTxt.setText(timeFrame_Model.getTimeFrame());
		orderNumberTxt.setText(timeFrame_Model.getOrderNumber());

		datePicker.setValue(LocalDate.now());
		driverChoiceBox.setValue(timeFrame_Model.getDriver());
