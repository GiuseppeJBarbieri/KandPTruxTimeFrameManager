...
public class Show_Edit_TimeFrame {
	...
	public Show_Edit_TimeFrame(Main_View_Controller main_View_Controller, AnchorPane main_view_pane,
			Client_Controller client, TimeFrame_Model timeFrame_Model, Store_Model store_Model) {
		try {
