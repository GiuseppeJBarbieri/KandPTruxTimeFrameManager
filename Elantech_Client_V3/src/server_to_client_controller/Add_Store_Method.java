...
public class Add_Store_Method {

	public Add_Store_Method(Object object, Client_Controller client) {
		Alert_Box alertBox = new Alert_Box();
		Add_Store_Request_Model obj = (Add_Store_Request_Model) object;
		...
		if (message.getInfoOrError() == 0) {
			...
			Platform.runLater(new Runnable() {
				...
				public void run() {
					...
					Add_Store_Controller view = client.getAddProductController();
					view.closeStage();
