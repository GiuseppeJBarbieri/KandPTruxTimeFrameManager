...
public class Show_Add_TimeFrame {
	...
	public Show_Add_TimeFrame(Main_View_Controller main_View_Controller, AnchorPane main_view_pane, Client_Controller client, User_Account_Information user_Account_Model, Store_Model store_Model) {
		try {
